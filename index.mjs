...
const BOT_TOKEN = "2107166346:AAGJjkFnjHNgPlSJp_jzGx4oZ3pdjV9JRGM"; // process.env.BOT_TOKEN; // or use dotenv to load it from a .env file
const bot = new Telegraf(BOT_TOKEN);

let api = `https://ccbot-6prv.onrender.com/api/`;
